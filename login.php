            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block mx-auto" src="images/blinker_fluid.jpg" alt="Blinker Fluid">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block mx-auto" src="images/flux_capacitor.jpg" alt="Flux Capacitor">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block mx-auto" src="images/muffler_bearing.jpg" alt="Muffler Bearing">
                    </div>
                </div>
        ...
        <div class="h-40 center-me">
            <div class="my-auto">
                <form class="form-signin" action="includes/login-helper.php" method="post">
                    ...
                    <h2>Login</h2>
                    <p class="hint-text">Login or else</p>
